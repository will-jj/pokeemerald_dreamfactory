...
static const u16 sMoves_TotalPreparation[] =
{
    ...
    MOVE_WITHDRAW, MOVE_DEFENSE_CURL, MOVE_BARRIER, MOVE_AMNESIA, MOVE_STOCKPILE,
...
{
    MOVE_MIMIC, MOVE_METRONOME, MOVE_MIRROR_MOVE, MOVE_TRANSFORM, MOVE_SUBSTITUTE,
...
static const u16 sMoves_WeakeningTheFoe[] =
{
    ...
    MOVE_MUD_SHOT, MOVE_ROCK_SMASH, MOVE_LUSTER_PURGE, MOVE_MIST_BALL, MOVE_CRUSH_CLAW,
    MOVE_NONE
};

static const u16 sMoves_HighRiskHighReturn[] =
{
    MOVE_DOUBLE_EDGE, MOVE_HYPER_BEAM, MOVE_COUNTER, MOVE_BELLY_DRUM, MOVE_SUPERPOWER,
    ...
    MOVE_ZAP_CANNON, MOVE_ENDEAVOR, MOVE_HIGH_JUMP_KICK, MOVE_DYNAMIC_PUNCH, MOVE_OUTRAGE, MOVE_THRASH, MOVE_PETAL_DANCE,
    MOVE_NONE
};
...
static const u16 sMoves_SlowAndSteady[] =
{
    ...
    MOVE_NIGHTMARE, MOVE_LICK, MOVE_BODY_SLAM, MOVE_SECRET_POWER, MOVE_POISON_STING, MOVE_SLUDGE, MOVE_SLUDGE_BOMB,
    MOVE_DRAGON_BREATH, MOVE_SPARK, MOVE_POISON_FANG, MOVE_SACRED_FIRE, MOVE_ROLLOUT, MOVE_ICE_BALL
    MOVE_NONE
};
...
{
    // Level 50
    {FRONTIER_MON_ABSOL_1,   FRONTIER_MON_YANMA_2},    // A
    {FRONTIER_MON_ABSOL_1,   FRONTIER_MON_XATU_2},     // A, B
    {FRONTIER_MON_ABSOL_1,   FRONTIER_MON_XATU_2},     // A, B
    {FRONTIER_MON_ABSOL_3,   FRONTIER_MON_ZANGOOSE_2}, // B, C
    {FRONTIER_MON_AGGRON_1,  FRONTIER_MON_WEEZING_2},  // C, D
    {FRONTIER_MON_AGGRON_1,  FRONTIER_MON_WEEZING_2},  // C, D
    {FRONTIER_MON_AGGRON_1,  FRONTIER_MON_ZAPDOS_4},   // C, D, E
    {FRONTIER_MON_AGGRON_1,  FRONTIER_MON_ZAPDOS_4},   // C, D, E

    // Open level
    {FRONTIER_MON_ABSOL_3,  FRONTIER_MON_XATU_2},      // B
    {FRONTIER_MON_ABSOL_3,  FRONTIER_MON_ZANGOOSE_2},  // B, C
    {FRONTIER_MON_ABSOL_3,  FRONTIER_MON_ZANGOOSE_2},  // B, C
    {FRONTIER_MON_AGGRON_1, FRONTIER_MON_WEEZING_2},   // C, D
    {FRONTIER_MON_AGGRON_3, FRONTIER_MON_ZAPDOS_4}},   // D, E
    {FRONTIER_MON_AGGRON_3, FRONTIER_MON_ZAPDOS_4}},   // D, E
    {FRONTIER_MON_AGGRON_3, NUM_FRONTIER_MONS - 1},    // D, E, F
    {FRONTIER_MON_AGGRON_3, NUM_FRONTIER_MONS - 1},    // D, E, F
};
