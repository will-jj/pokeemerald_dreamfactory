...
{
    MOVE_SWORDS_DANCE, MOVE_GROWTH, MOVE_MEDITATE, MOVE_AGILITY, MOVE_HARDEN,
    MOVE_WITHDRAW, MOVE_DEFENSE_CURL, MOVE_BARRIER, MOVE_AMNESIA, MOVE_ROLLOUT,
    MOVE_ACID_ARMOR, MOVE_SHARPEN, MOVE_CONVERSION, MOVE_CONVERSION_2, MOVE_PSYCH_UP,
...
{
    MOVE_MIMIC, MOVE_METRONOME, MOVE_MIRROR_MOVE, MOVE_TRANSFORM, MOVE_SUBSTITUTE, MOVE_CURSE,
...
{
    MOVE_TAIL_WHIP, MOVE_LEER, MOVE_GROWL, MOVE_STRING_SHOT, MOVE_SCREECH,
    MOVE_COTTON_SPORE, MOVE_SPITE, MOVE_SCARY_FACE, MOVE_CHARM, MOVE_KNOCK_OFF, MOVE_SWEET_SCENT, MOVE_FEATHER_DANCE,
    MOVE_FAKE_TEARS, MOVE_METAL_SOUND, MOVE_TICKLE, MOVE_THIEF, MOVE_COVET, MOVE_SUPER_FANG,
    MOVE_NONE
};

static const u16 sMoves_HighRiskHighReturn[] =
{
    MOVE_DOUBLE_EDGE, MOVE_HYPER_BEAM, MOVE_COUNTER, MOVE_BELLY_DRUM, MOVE_SILVER_WIND, MOVE_ANCIENT_POWER,
    ...
    MOVE_ZAP_CANNON, MOVE_ENDEAVOR, MOVE_HIGH_JUMP_KICK, MOVE_DYNAMIC_PUNCH,
    MOVE_NONE
};
...
static const u16 sMoves_DependsOnTheBattlesFlow[] =
{
    ...
    MOVE_ERUPTION, MOVE_WATER_SPOUT, MOVE_REVENGE,
    MOVE_NONE
};
