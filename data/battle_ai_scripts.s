...
AI_CBM_TestWhetherToTypeMatchup_MirrorMove:
	...
	goto AI_CBM_TypeMatchup_Modifiers_MirrorMove

AI_CBM_TestWhetherToTypeMatchup_Status_MirrorMove:
	if_status AI_TARGET, STATUS1_ANY, AI_CBM_TypeMatchup_Modifiers_MirrorMove
	get_last_used_bank_move AI_TARGET
	get_considered_move_second_eff_chance_from_result
	if_less_than 25, AAI_CBM_TypeMatchup_Modifiers_MirrorMove
	goto AI_CBM_Soundproof_MirrorMove

AI_CBM_TestWhetherToTypeMatchup_ItemCheck_MirrorMove:
	get_ability AI_TARGET
	if_equal ABILITY_STICKY_HOLD, AI_CBM_TypeMatchup_Modifiers_MirrorMove
	get_hold_effect AI_TARGET
	if_not_in_bytes AI_CV_Thief_EncourageItemsToSteal, AI_CBM_TypeMatchup_Modifiers_MirrorMove
	goto AI_CBM_Soundproof_MirrorMove

AI_CBM_TestWhetherToTypeMatchup_Speed_MirrorMove:
	get_ability AI_TARGET
	if_equal ABILITY_CLEAR_BODY, AI_CBM_TypeMatchup_Modifiers_MirrorMove
	if_equal ABILITY_WHITE_SMOKE, AI_CBM_TypeMatchup_Modifiers_MirrorMove
	if_equal ABILITY_SPEED_BOOST, AI_CBM_TypeMatchup_Modifiers_MirrorMove
	if_side_affecting AI_TARGET, SIDE_STATUS_MIST, AI_CBM_TypeMatchup_Modifiers_MirrorMove
	if_target_faster AI_CBM_Soundproof_MirrorMove
AI_CBM_TypeMatchup_MirrorMove_Modifiers_MirrorMove:
	get_last_used_bank_move AI_TARGET
	get_move_type_from_result
